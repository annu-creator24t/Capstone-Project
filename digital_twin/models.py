...
class AnomalyLevel(str, Enum):
    """Detection severity level produced by the baseline anomaly detector."""
    NORMAL = "normal"
    WARNING = "warning"
    ANOMALY = "anomaly"
...
class AnomalyEvaluationResult:
    """Comprehensive evaluation record generated by the Baseline Anomaly Detector."""
    vehicle_id: str
    sensor_name: str
    timestamp: float
    observed_value: Optional[float]
    ...
    relative_threshold_used: Optional[float] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Convert anomaly result to serializable dictionary."""
        data = asdict(self)
        data["anomaly_level"] = self.anomaly_level.value
        data["freshness_status"] = self.freshness_status.value
        return data
